...
var destFolder = './dist';
var sourceFile = './lib/split_columns.coffee'
...
gulp.task("app", function () {
  ...
  return bundleShare(bundle, "split_columns.min.js")
});
...
gulp.task('app:watch', function() {
  ...
  b.on('update', function(){
    bundleShare(b, "split_columns.js");
  });

  return bundleShare(b, "split_columns.js");
})
